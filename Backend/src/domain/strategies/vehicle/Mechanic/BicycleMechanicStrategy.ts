import { BicycleMecanicBuilder } from '../../../builders/vehicle/Mecanic/BycicleMechanicalBuilder'
...
export class BicycleMechanicalEstrategy implements VehicleStrategy {
  private readonly builder: BicycleMecanicBuilder
  constructor () {
    this.builder = new BicycleMecanicBuilder()
  }
