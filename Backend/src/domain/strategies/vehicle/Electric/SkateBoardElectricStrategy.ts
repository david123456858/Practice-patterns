import { SkateboardElectricBuilder } from '../../../builders/vehicle/Electric/SkateBoardElectric'
...
export class SkateboardElectricEstrategy implements VehicleStrategy {
  private readonly builder: SkateboardElectricBuilder
  constructor () {
    this.builder = new SkateboardElectricBuilder()
  }
