import { ScooterElectricBuilder } from '../../../builders/vehicle/Electric/ScooterElectricBuilder'
...
export class ScooterElectricEstrategy implements VehicleStrategy {
  private readonly builder: ScooterElectricBuilder
  constructor () {
    this.builder = new ScooterElectricBuilder()
  }
