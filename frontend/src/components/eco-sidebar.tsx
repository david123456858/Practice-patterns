...
import { Leaf, Zap, Home, Users, Car, MapPin, FileText } from "lucide-react"
...
const menuItems = [
    ...
    { id: "loans", label: "Gestión préstamo", icon: FileText },
]
    ...
    return (
        <div className="flex h-screen w-64 flex-col bg-gradient-to-b from-green-50 to-green-100 border-r border-green-200">
            ...
            <div className="flex items-center gap-3 p-6 border-b border-green-200">
                ...
                <h1 className="text-2xl font-bold text-green-800">EcoMove Administrador</h1>
            </div>
            ...
            <div className="p-4 border-t border-green-200">
                <div className="text-center text-sm text-green-600">
                    <a href="/login" className="font-semibold text-xl cursor-pointer ">Salir</a>
