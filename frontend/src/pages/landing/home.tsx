...
export default function HomePage() {
    return (
        <div className="min-h-screen flex flex-col bg-gradient-to-br from-background via-muted/30 to-secondary/20">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-4xl w-full">
                    <Card className="shadow-lg border-border/50 hover:shadow-xl transition-shadow">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Accede a tu cuenta existente para continuar tu viaje ecológico
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Link to="/login">
                    ...
                    <Card className="shadow-lg border-border/50 hover:shadow-xl transition-shadow">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Regístrate y comienza a formar parte de la comunidad EcoMove
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Link to="/register">
